...
namespace NSGPassManagement.Forms
{
    public partial class frmPassHolderSearch : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            frmNSGPass visitorEntryForm = new frmNSGPass();
        ...
        private void LoadValues()
        {
            ...
            {
                passTypeID = Convert.ToInt16(cmbPassType.SelectedValue);
            }

            var passHoldersDetail = DB.PassHolderDetailsGet(issueDate, expiryDate, passNumber, txtPersonName.Text, passTypeID, txtVehicleNumber.Text);
            ...
            if (grdPassHolderDetails.Rows.Count > 0)
            {
                lblTotalRecordCount.Text = "Total Records Found: (" + Convert.ToString(grdPassHolderDetails.Rows.Count) + ") out of [" + Convert.ToString(DB.NSGPasses.Count()) + "]";
            }
            else
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            frmNSGPass nsgPassForm = new frmNSGPass(int.Parse(grdPassHolderDetails.CurrentRow.Cells[0].Value.ToString()));
            nsgPassForm.MdiParent = this.MdiParent;
            //this.Hide();
            nsgPassForm.Show();
            //this.Close();
        }
        ...
        private string GetExportFileName(string format)
        {
            ...
            fileName = dir + @"\NSGPassDetails" + DateTime.Now.ToString("dd_MM_yyyy hh_mm_ss") + ".xls";
